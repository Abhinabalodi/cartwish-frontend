...
import idButton from "../../assets/id-button.jpg";
...
const Navbar = () => {
    ...
    useEffect(() => {
        const delaySuggetions = setTimeout(() => {
            if(search.trim() !== ""){
         ...
         return () => clearTimeout(delaySuggetions)
    }, [search])
            ...
            <div className='align_center'>
                ...
                <form className='align_center navbar_form' onSubmit={handleSubmit}>
                    ...
                    {suggestions.length > 0 && <ul className="search_result">
                        ...
                        <li className={selectedItem === index ? "search_suggestion_link active"
